                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y ">
                            <h4 class="fw-bold py-3 mb-4">Customer Orders Management and Assignment</h4>
                            <c:if test="${not empty sessionScope.msg}">
                                <div class="alert alert-success alert-dismissible fade show" role="alert" style="text-align: center">
                                    ${sessionScope.msg}
                                    <button style="border-radius: 20%; background-color: #d93519; color: #ffffff; margin-left: 5px" type="button" class="btn-danger" data-bs-dismiss="alert" aria-label="Close">x</button>
                                </div>
                                <%
                                ...
                                <div class="table-responsive text-nowrap listtable">
                                    <table style="width: 100%" id="data-table" class="table">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            <c:forEach items="${requestScope.listOrder}" var="obj" varStatus="index">
                                                <tr>
                                                    <td>${index.index + 1}</td>
                                                        ...
                                                        <c:forEach items="${listOrderStatus}" var="ods" > 
                                                            <c:if test="${ods.id == obj.getOrder_status()}">
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${obj.getOrder_status() == 6}">
                                                                        <span style="background: blue" class="badge text-bg-primary">${ods.name}</span>
                                                                    </c:when>
                                                                    <c:when test="${obj.getOrder_status() == 7}">
                                                                        <span style="background: red" class="badge text-bg-primary">${ods.name}</span>
                                                                    </c:when>
                                                                </c:choose>
                                                    ...
                                                    <c:if test="${obj.getOrder_status() == 1}">
                                                        <td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <button style="border-radius: 20%" class="close" type="button" data-bs-dismiss="modal" aria-label="Close">
