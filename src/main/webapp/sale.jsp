                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${s.getOrder_status() == 1}">
                                                                <span style="background: gray" class="badge text-bg-primary">Pending</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 2}">
                                                                <span style="background: blue" class="badge text-bg-primary">Prepared Order</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 3}">
                                                                <span style="background: blue" class="badge text-bg-primary">Package Order</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 4}">
                                                                <span style="background: blue" class="badge text-bg-primary">Delivering</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 5}">
                                                                <span style="background: green" class="badge text-bg-primary">Successfully</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 6}">
                                                                <span style="background: green" class="badge text-bg-primary">Confirmed</span>
                                                            </c:when>
                                                            <c:when test="${s.getOrder_status() == 7}">
                                                                <span style="background: red" class="badge text-bg-primary">Cancel</span>
                                                            </c:when>
                                                        </c:choose>
                                                    </td>
                                                    <td>
