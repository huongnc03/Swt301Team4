    ...
    public List<OrderDetail> getOrderItems(String orderID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                int varanty = rs.getInt("VariationID");
                OrderDetail or = new OrderDetail(xOrder_detailID, xProductID, xOrderID, xQuantity, xPrice, xOrderDate);
                or.setVariationID(varanty);
                od.add(or);
            }
            rs.close();
            ps.close();
