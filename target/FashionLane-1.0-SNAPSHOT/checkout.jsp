    ...
    <head>
        ...
        <style>
            ...
            .address-option.selected {
                background-color: #f0f0f0; /* Màu nền highlight */
                border: 1px solid #ccc; /* Viền highlight */
                cursor: pointer; /* Con trỏ chỉ vào */
            }
    ...
    <body>
        ...
        <section class="Checkout_Container">
            <div class="Information_Container">
                ...
                <c:set var="tempAddressId" value="0" />
                <c:if test="${tempAddress != null}">
                    <c:set var="tempAddressId" value="${tempAddress.addressID}" />
                    <div class="Shipping">
                        ...
                        <form action="Checkout?mod=1" method="post">
                            <input id="addressId" value="${tempAddress.addressID}" name="addressId" type="hidden" required><br>
                            <c:forEach items="${sessionScope.countryList}" var="c">
                                <c:if test="${c.countryID == tempAddress.countryid}">
                                    <div class="form-group">
                                        <label for="addressShow">Country:</label>
                                        <input id="addressShow" type="text" readonly value="${c.countryName}">
                                    </div>
                                </c:if>
                            </c:forEach>
                            <div class="form-group">
                                <label for="recipient">Full Name:</label>
                                <input readonly id="recipient" value="${tempAddress.fullname}" name="recipient" placeholder="Full Name" type="text" required><br>
                            </div>
                            <div class="form-group">
                                <label for="Street">Address Line:</label>
                                <input readonly value="${tempAddress.addressLine}" id="Street" name="address_line" placeholder="Address Line" type="text" required><br>
                            </div>
                            <div class="form-group">
                                <label for="city">City:</label>
                                <input readonly value="${tempAddress.city}" id="city" name="city" placeholder="City*" type="text" required><br>
                            </div>
                            <div class="form-group">
                                <label for="postalcode">Postal Code:</label>
                                <input readonly value="${tempAddress.postcode}" id="postalcode" name="postalcode" placeholder="Postal Code*" type="number" min="0" required><br>
                            </div>
                            <div class="form-group">
                                <label for="recipent_phone">Phone Number:</label>
                                <input readonly value="${tempAddress.phone}" id="recipent_phone" name="recipent_phone" placeholder="Phone Number*" type="tel" required><br>
                            </div>
                        ...
                        <button type="button" class="btn-primary" onclick="openModal('addressModal')">Choose Address</button>
                    </div>
                </c:if>
                <c:if test="${tempAddress == null}">
                    <c:forEach begin="0" end="0" items="${sessionScope.addressList}" var="address">
                        <c:set var="tempAddressId" value="${address.addressID}" />
                        <div class="Shipping">
                            <div class="Information_Title">
                                <h1>1</h1>
                                <h1>Shipping</h1>
                            ...
                            <form action="Checkout?mod=1" method="post">
                                <input id="addressId" value="${address.addressID}" name="addressId" type="hidden" required><br>
                                <c:forEach items="${sessionScope.countryList}" var="c">
                                    <c:if test="${c.countryID == address.countryid}">
                                        <div class="form-group">
                                            <label for="addressShow">Country:</label>
                                            <input id="addressShow" type="text" readonly value="${c.countryName}">
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="recipient">Full Name:</label>
                                    <input readonly id="recipient" value="${address.fullname}" name="recipient" placeholder="Full Name" type="text" required><br>
                                </div>
                                <div class="form-group">
                                    <label for="Street">Address Line:</label>
                                    <input readonly value="${address.addressLine}" id="Street" name="address_line" placeholder="Address Line" type="text" required><br>
                                </div>
                                <div class="form-group">
                                    <label for="city">City:</label>
                                    <input readonly value="${address.city}" id="city" name="city" placeholder="City*" type="text" required><br>
                                </div>
                                <div class="form-group">
                                    <label for="postalcode">Postal Code:</label>
                                    <input readonly value="${address.postcode}" id="postalcode" name="postalcode" placeholder="Postal Code*" type="number" min="0" required><br>
                                </div>
                                <div class="form-group">
                                    <label for="recipent_phone">Phone Number:</label>
                                    <input readonly value="${address.phone}" id="recipent_phone" name="recipent_phone" placeholder="Phone Number*" type="tel" required><br>
                                </div>
                                <h1 style="color:red; font-family: 'Nunito Sans', sans-serif; font-size: 14px">${ShippMessError}</h1>
                                <h1 style="color:green;font-family: 'Nunito Sans', sans-serif;  font-size: 14px">${ShippMess}</h1>
                            </form>
                    ...
                    <c:if test="${sessionScope.addressList.size() == 0}">
                        <div class="Shipping">
                            <div class="Information_Title">
                                <h1>1</h1>
                                <h1>Shipping</h1>
            ...
            <div class="Cart_List_Container">
                ...
                <form action="order" method="post">
                    <input type="hidden" id="addressIdCheckout" name="addressIdCheckout" value="${tempAddressId}" />
                    <div class="Place_Order_Container">
                        ...
                        <c:if test="${sessionScope.addressList.size() == 0}">
                            <a class="button">Please add new address</a>
                        </c:if>
        ...
        <div id="addressModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <c:forEach items="${sessionScope.addressList}" var="address" varStatus="index">
                        <div class="address-option ${index.index == 0 ? "selected" : ""}" onclick="selectAddress('${address.fullname}', '${address.addressLine}', '${address.city}', '${address.postcode}', '${address.phone}', '${address.countryid}', '${address.addressID}', this)">
                            <p>${address.fullname}</p>
                            <p>${address.addressLine}, ${address.city} ,
                                <c:forEach items="${sessionScope.countryList}" var="c">
                                    <c:if test="${c.countryID == address.countryid}">
                                        ${c.countryName}
                                        <input type="hidden" value="${c.countryName}" id="address-get-id-${address.countryid}" />
                                    </c:if>
                                </c:forEach>
                            </p>
                            <p>${address.postcode}</p>
                            <p>${address.phone}</p>
                            <button class="btn-success btn-add" onclick="editAddress('${acc.firstName} ${acc.lastName}', '${address.addressLine}', '${address.city}', '${address.postcode}', '${acc.phone}', '${address.countryid}', '${address.addressID}', this)">Edit</button>
                        </div>
                        <hr>
                    </c:forEach>
                    <button class="btn-primary btn-add" onclick="openModal('newAddressModal')">Add New Address</button>
                </div>
                <div class="modal-footer">
                    <button class="btn-secondary" onclick="closeModal('addressModal')">Close</button>
                </div>
            </div>
        </div>
        <div id="editAddressModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editAddressForm" action="Checkout?mod=4" method="post">
                        <input type="hidden" id="addressEditId" name="addressId">
                        <input type="text" id="fullnameEdit" name="fullname" placeholder="Fullname" required><br>
                        <input type="text" id="StreetEdit" name="address_line" placeholder="Address Line" required><br>
                        <input type="text" id="cityEdit" name="city" placeholder="City" required><br>
                        <input type="text" id="phoneEdit" name="phone" placeholder="Phone" required><br>
                        <input type="number" id="postalcodeEdit" name="postalcode" placeholder="Postal Code" required><br>
                ...
                <div class="modal-footer">
                    <button class="btn-secondary" onclick="closeModal('editAddressModal')">Close</button>
                </div>
            </div>
        </div>
        <div id="newAddressModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span class="close" onclick="closeModal('newAddressModal')">&times;</span>
                </div>
                <div class="modal-body">
                    <form id="newAddressForm" action="Checkout?mod=3" method="post">
                ...
                <div class="modal-footer">
                    <button class="btn-secondary" onclick="closeModal('newAddressModal')">Close</button>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            function selectAddress(fullName, addressLine, city, postcode, phone, countryID, addressId, element) {
                var selectedAddress = document.querySelector('.address-option.selected');
                if (selectedAddress) {
                    selectedAddress.classList.remove('selected');
                }
                element.classList.add('selected');
                document.querySelector("#addressIdCheckout").value = addressId;
                document.getElementById('addressId').value = addressId;
                document.getElementById('addressShow').value = document.getElementById('address-get-id-' + countryID).value;
                document.getElementById('recipient').value = fullName;
                document.getElementById('Street').value = addressLine;
                document.getElementById('city').value = city;
                document.getElementById('postalcode').value = postcode;
                document.getElementById('recipent_phone').value = phone;
                document.getElementById('CountryID').value = countryID;
                closeModal('addressModal');
            }

            function editAddress(fullName, addressLine, city, postcode, phone, countryID, addressId, element) {
                document.getElementById('fullnameEdit').value = fullName;
                document.getElementById('phoneEdit').value = phone;
                document.getElementById('addressEditId').value = addressId;
                document.getElementById('StreetEdit').value = addressLine;
                document.getElementById('cityEdit').value = city;
                document.getElementById('postalcodeEdit').value = postcode;
                document.getElementById('CountryID').value = countryID;
                closeModal('addressModal');
            ...
            window.onclick = function (event) {
                ...
                if (event.target == addressModal) {
                    closeModal('addressModal');
                } else if (event.target == newAddressModal) {
